...
void grsds(zhigong *p1)//计算个人所得税函数
{
		...
		else if(p1->yingfa<2000)                   //应发工资在500到2000
			p1->geren=(p1->yingfa-2000)*0.1+500*0.05;
		else if(p1->yingfa<5000)                                //应发工资在2000到5000
			p1->geren=(p1->yingfa-5000)*0.15+1500*0.1+500*0.05;
		else if(p1->yingfa<20000)                                          //应发工资在5000到20000
			p1->geren=(p1->yingfa-20000)*0.2+15000*0.15+1500*0.1+500*0.05;
		else if(p1->yingfa<40000)                                                     //应发工资在20000到40000
			p1->geren=(p1->yingfa-40000)*0.25+20000*0.2+15000*0.15+1500*0.1+500*0.05;
		else if(p1->yingfa<60000)                                                                 //应发工资在40000到60000
			p1->geren=(p1->yingfa-60000)*0.3+20000*0.25+20000*0.2+15000*0.15+1500*0.1+500*0.05;
		else if(p1->yingfa<80000)                                                                            //应发工资在60000到80000
			p1->geren=(p1->yingfa-80000)*0.35+20000*0.3+20000*0.25+20000*0.2+15000*0.15+1500*0.1+500*0.05;
		else if(p1->yingfa<100000)                                                                                   //应发工资在80000到100000
